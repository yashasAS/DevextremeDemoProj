...
declare type ISparklineOptions = React.PropsWithChildren<Properties & IHtmlOptions & {}>;
declare class Sparkline extends BaseComponent<React.PropsWithChildren<ISparklineOptions>> {
