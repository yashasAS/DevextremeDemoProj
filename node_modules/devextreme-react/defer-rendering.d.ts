...
declare type IDeferRenderingOptions = React.PropsWithChildren<Properties & IHtmlOptions & {}>;
declare class DeferRendering extends BaseComponent<React.PropsWithChildren<IDeferRenderingOptions>> {
