...
declare type IMultiViewOptions<TItem = any, TKey = any> = React.PropsWithChildren<Properties<TItem, TKey> & IHtmlOptions & {
...
declare class MultiView<TItem = any, TKey = any> extends BaseComponent<React.PropsWithChildren<IMultiViewOptions<TItem, TKey>>> {
    get instance(): dxMultiView<TItem, TKey>;
