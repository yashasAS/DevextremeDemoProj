...
declare type ILinearGaugeOptions = React.PropsWithChildren<Properties & IHtmlOptions & {
...
declare class LinearGauge extends BaseComponent<React.PropsWithChildren<ILinearGaugeOptions>> {
