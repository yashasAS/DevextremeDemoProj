...
declare type IDateBoxOptions = React.PropsWithChildren<Properties & IHtmlOptions & {
...
declare class DateBox extends BaseComponent<React.PropsWithChildren<IDateBoxOptions>> {
