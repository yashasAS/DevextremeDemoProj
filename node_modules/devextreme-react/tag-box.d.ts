...
declare type ITagBoxOptions = React.PropsWithChildren<Properties & IHtmlOptions & {
...
declare class TagBox extends BaseComponent<React.PropsWithChildren<ITagBoxOptions>> {
