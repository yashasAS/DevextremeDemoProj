...
declare type IToolbarOptions<TItem = any, TKey = any> = React.PropsWithChildren<Properties<TItem, TKey> & IHtmlOptions & {
...
declare class Toolbar<TItem = any, TKey = any> extends BaseComponent<React.PropsWithChildren<IToolbarOptions<TItem, TKey>>> {
    get instance(): dxToolbar<TItem, TKey>;
