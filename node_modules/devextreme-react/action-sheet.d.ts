...
declare type IActionSheetOptions<TItem = any, TKey = any> = React.PropsWithChildren<Properties<TItem, TKey> & IHtmlOptions & {
...
declare class ActionSheet<TItem = any, TKey = any> extends BaseComponent<React.PropsWithChildren<IActionSheetOptions<TItem, TKey>>> {
