...
declare type IDropDownButtonOptions = React.PropsWithChildren<Properties & IHtmlOptions & {
...
declare class DropDownButton extends BaseComponent<React.PropsWithChildren<IDropDownButtonOptions>> {
