...
declare type ITabsOptions<TItem = any, TKey = any> = React.PropsWithChildren<Properties<TItem, TKey> & IHtmlOptions & {
...
declare class Tabs<TItem = any, TKey = any> extends BaseComponent<React.PropsWithChildren<ITabsOptions<TItem, TKey>>> {
    get instance(): dxTabs<TItem, TKey>;
