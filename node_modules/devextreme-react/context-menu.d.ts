...
declare type IContextMenuOptions<TKey = any> = React.PropsWithChildren<Properties<TKey> & IHtmlOptions & {
...
declare class ContextMenu<TKey = any> extends BaseComponent<React.PropsWithChildren<IContextMenuOptions<TKey>>> {
    get instance(): dxContextMenu<TKey>;
