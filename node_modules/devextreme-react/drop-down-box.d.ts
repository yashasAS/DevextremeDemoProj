...
declare type IDropDownBoxOptions = React.PropsWithChildren<Properties & IHtmlOptions & {
...
declare class DropDownBox extends BaseComponent<React.PropsWithChildren<IDropDownBoxOptions>> {
