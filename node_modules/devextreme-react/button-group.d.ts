...
declare type IButtonGroupOptions = React.PropsWithChildren<Properties & IHtmlOptions & {
...
declare class ButtonGroup extends BaseComponent<React.PropsWithChildren<IButtonGroupOptions>> {
