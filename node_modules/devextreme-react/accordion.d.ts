...
declare type IAccordionOptions<TItem = any, TKey = any> = React.PropsWithChildren<Properties<TItem, TKey> & IHtmlOptions & {
...
declare class Accordion<TItem = any, TKey = any> extends BaseComponent<React.PropsWithChildren<IAccordionOptions<TItem, TKey>>> {
    get instance(): dxAccordion<TItem, TKey>;
