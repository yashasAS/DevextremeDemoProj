...
declare type ITabPanelOptions<TItem = any, TKey = any> = React.PropsWithChildren<Properties<TItem, TKey> & IHtmlOptions & {
...
declare class TabPanel<TItem = any, TKey = any> extends BaseComponent<React.PropsWithChildren<ITabPanelOptions<TItem, TKey>>> {
    get instance(): dxTabPanel<TItem, TKey>;
