...
declare type ITextBoxOptions = React.PropsWithChildren<Properties & IHtmlOptions & {
    defaultValue?: any;
    onValueChange?: (value: any) => void;
}>;
declare class TextBox extends BaseComponent<React.PropsWithChildren<ITextBoxOptions>> {
