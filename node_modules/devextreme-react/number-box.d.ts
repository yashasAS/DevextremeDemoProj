...
declare type INumberBoxOptions = React.PropsWithChildren<Properties & IHtmlOptions & {
    defaultValue?: any;
    onValueChange?: (value: any) => void;
}>;
declare class NumberBox extends BaseComponent<React.PropsWithChildren<INumberBoxOptions>> {
